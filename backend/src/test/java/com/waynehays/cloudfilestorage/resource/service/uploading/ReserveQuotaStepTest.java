...
class ReserveQuotaStepTest {
    ...
    void rollback_shouldReleaseSpace_whenQuotaWasReserved() {
        // given
        UploadRollbackSnapshot snapshot = new UploadRollbackSnapshot(1L, 1000L, true, List.of(), List.of());
    ...
    void rollback_shouldDoNothing_whenQuotaWasNotReserved() {
        // given
        UploadRollbackSnapshot snapshot = new UploadRollbackSnapshot(1L, 1000L, false, List.of(), List.of());
