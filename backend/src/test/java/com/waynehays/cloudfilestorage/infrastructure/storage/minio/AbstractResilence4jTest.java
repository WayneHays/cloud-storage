...
abstract class AbstractResilence4jTest {
    static final String EXCLUDE_INFRASTRUCTURE_AUTOCONFIG = "spring.autoconfigure.exclude=" +
    ...
    static final String RETRY_NAME = "minioStorage";
    static final String CB_NAME = "minioStorage";
