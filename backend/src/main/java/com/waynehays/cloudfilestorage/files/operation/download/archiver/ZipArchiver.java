...
import com.waynehays.cloudfilestorage.files.operation.download.exception.ArchiveException;
...
class ZipArchiver implements ArchiverApi {
    ...
    private void addFileToArchive(ZipArchiveOutputStream zos, ArchiveItem item) throws IOException {
        ...
        try (InputStream inputStream = item.inputStreamSource().getInputStream()) {
