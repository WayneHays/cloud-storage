...
import com.waynehays.cloudfilestorage.files.api.dto.request.DeleteRequest;
import com.waynehays.cloudfilestorage.files.api.dto.request.DownloadRequest;
import com.waynehays.cloudfilestorage.files.api.dto.request.GetInfoRequest;
import com.waynehays.cloudfilestorage.files.api.dto.request.MoveRequest;
import com.waynehays.cloudfilestorage.files.api.dto.request.SearchRequest;
import com.waynehays.cloudfilestorage.files.api.dto.request.UploadRequest;
...
interface ResourceControllerApi {
    ...
    ResourceResponse getResourceInfo(@AuthenticationPrincipal CustomUserDetails userDetails,
    ...
    ResourceResponse moveOrRenameResource(@AuthenticationPrincipal CustomUserDetails userDetails,
    ...
    List<ResourceResponse> searchResource(@AuthenticationPrincipal CustomUserDetails userDetails,
    ...
    List<ResourceResponse> uploadResource(@AuthenticationPrincipal CustomUserDetails userDetails,
